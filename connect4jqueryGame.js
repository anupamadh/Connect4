        ...
        */
        ...
        listen: function() {
          $(".dropPanel div").click(function(event) {
                ...
                //Indicates to the user that columns will be swapped in the next move
                if (this.totalMovesLeft === 33) {
                  $(".newGamePanel").html('SWAPPING COLUMNS');
                }
                  else if (this.totalMovesLeft === 32) {
                    this.swapColumns(swapArray[0], swapArray[1]);
                    // this.swapColumns();
                  } else if (this.totalMovesLeft < 32) {
                    $(".newGamePanel").html('Click here for New Game');
                  }
